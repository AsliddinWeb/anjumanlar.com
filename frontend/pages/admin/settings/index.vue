    ...
    <section class="space-y-3">
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
        ...
        >
          <!-- Palette preview -->
          <div
            class="h-28 flex items-stretch"
            :style="{ background: t_.palette.bg }"
          >
            <div class="flex-1 flex flex-col justify-end p-3 gap-1">
              <div
                class="h-3 w-3/4 rounded-full"
                :style="{ background: t_.palette.textPrimary, opacity: 0.85 }"
              />
              <div
                class="h-2 w-1/2 rounded-full"
                :style="{ background: t_.palette.textSecondary, opacity: 0.6 }"
              />
            </div>
